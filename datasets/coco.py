...
def make_augment(image_set):
    ...
    if 'train' in image_set:
        ...
        t.append(T1.Compose([
            T1.RandomApply(
                [T1.ColorJitter(0.4, 0.4, 0.4, 0.1)], p=0.8
            ),
            T1.RandomGrayscale(p=0.2),
            T1.RandomApply([T1.GaussianBlur(kernel_size=(5, 9), sigma=(0.1, 5))], p=0.5),
        ]))
        return t
...
def make_coco_transforms_ssl(image_set):
